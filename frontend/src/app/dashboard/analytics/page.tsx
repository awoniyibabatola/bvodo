      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
          <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6">
            ...
            <div className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">{metrics.flights}</div>
            <div className="text-xs md:text-sm text-gray-600">Total Flights</div>
          </div>
          ...
          <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6">
            ...
            <div className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">{metrics.hotels}</div>
            <div className="text-xs md:text-sm text-gray-600">Total Hotels</div>
          </div>

          <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-10 h-10 bg-[#ADF802] rounded-lg flex items-center justify-center">
            ...
            <div className="text-xs md:text-sm text-gray-600">Total Spend</div>
          </div>
          ...
          <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6">
            ...
            <div className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">{metrics.destinations}</div>
              ...
              <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Total distribution</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {topDestinations.map((dest, index) => (
                    <div key={dest.destination} className="flex items-center gap-3">
                      <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 text-gray-900 font-bold text-sm flex-shrink-0">
                        {index + 1}
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <MapPin className="w-4 h-4 text-gray-400 flex-shrink-0" />
                          <p className="text-sm font-semibold text-gray-900 truncate">{dest.destination}</p>
                        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {activeTrips.map(trip => (
                  <Link
                    ...
                    className="group border border-gray-200 rounded-xl p-4 hover:border-gray-300 hover:shadow-sm transition-all"
                  >
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-mono text-xs text-gray-600">{trip.bookingReference}</span>
                          <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-[#ADF802]/20 text-gray-900 border border-[#ADF802]/30">
                            Active
                          </span>
                        </div>
                        ...
                        <p className="text-xs text-gray-600">{trip.user.email}</p>
                      </div>
                    </div>
