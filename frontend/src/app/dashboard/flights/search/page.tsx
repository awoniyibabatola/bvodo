              ...
              <div className="lg:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 md:pl-12 pr-3 md:pr-4 py-4 text-lg border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none min-h-[48px]"
                  />
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        min={new Date().toISOString().split('T')[0]}
                        required
                        className="w-full pl-10 pr-3 py-4 text-lg border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 outline-none min-h-[48px]"
                      />
                    </div>
                  </div>
