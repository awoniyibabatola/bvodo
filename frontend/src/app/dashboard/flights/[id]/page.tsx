        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h1 className="text-lg font-bold text-gray-900 mb-4">Flight Details</h1>
                              ...
                              <div className="flex items-center gap-3 flex-1">
                                ...
                                {!isExpanded && (
                                  <div className="flex items-start gap-4 mr-2">
                                    <div className="text-center">
                                      <div className="text-lg font-bold text-gray-900">{segmentDeparture.iataCode}</div>
                                    ...
                                    <div className="flex flex-col items-center pt-6">
                                      ...
                                      <div className="text-xs text-gray-600 font-medium mt-1">{formatDuration(segment.duration)}</div>
                                    </div>
                                    <div className="text-center">
                                      <div className="text-lg font-bold text-gray-900">{segmentArrival.iataCode}</div>
                              ...
                              <div className="mt-3 pt-3 border-t border-gray-200 space-y-2">
                                <div className="grid grid-cols-2 gap-3">
                                  <div>
                                    ...
                                    <div className="text-sm font-semibold text-gray-700">{segmentDeparture.city || AIRPORT_NAMES[segmentDeparture.iataCode]?.city || segmentDeparture.iataCode}</div>
                                    <div className="text-xs text-gray-600">{segmentDeparture.airport || AIRPORT_NAMES[segmentDeparture.iataCode]?.airport || segmentDeparture.iataCode}</div>
                                    <div className="text-xs text-gray-500">{segDeparture.date}</div>
                                  </div>
                                  <div>
                                    ...
                                    <div className="text-sm font-semibold text-gray-700">{segmentArrival.city || AIRPORT_NAMES[segmentArrival.iataCode]?.city || segmentArrival.iataCode}</div>
                                    <div className="text-xs text-gray-600">{segmentArrival.airport || AIRPORT_NAMES[segmentArrival.iataCode]?.airport || segmentArrival.iataCode}</div>
                                    <div className="text-xs text-gray-500">{segArrival.date}</div>
                                  </div>
                                </div>
                          ...
                          {segIndex < itinerary.segments.length - 1 && (() => {
                            ...
                            return (
                              <div className="flex items-center justify-center py-2">
                                <div className="px-3 py-1.5 bg-gray-50 border border-gray-200 rounded text-xs text-gray-700">
            ...
            {/* Baggage & Policies */}
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              <h2 className="text-base font-bold text-gray-900 mb-3">Baggage & Policies</h2>
                    ...
                    (fareDetail: any, index: number) => (
                      ...
                      >
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          <span className="font-semibold text-gray-900 text-sm">Segment {index + 1}</span>
                        </div>
                        <div className="text-xs text-gray-600">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 bg-white rounded-lg p-4 border border-gray-200">
              <h2 className="text-base font-bold text-gray-900 mb-3">Booking Summary</h2>
              ...
              <button
                ...
                className={`w-full px-4 py-3 rounded-lg text-base font-semibold transition-colors flex items-center justify-center gap-2 ${
