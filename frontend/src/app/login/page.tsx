          ...
          <div className="p-5 sm:p-8 lg:p-12 flex flex-col justify-center relative">
            ...
            <div className="max-w-md mx-auto w-full">
              <div className="mb-6 sm:mb-8">
                ...
                <p className="text-sm sm:text-base text-gray-600">Access your dashboard and manage your travel</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div className="group">
                  <div className="flex items-center justify-between mb-1.5 sm:mb-2">
                    ...
                    <Link href="/forgot-password" className="text-xs sm:text-sm text-blue-600 hover:text-purple-600 font-medium transition-colors">
                      Forgot?
                    </Link>
                  </div>
                  <div className="relative">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember" className="ml-2 text-xs sm:text-sm text-gray-700 cursor-pointer">
              ...
              <div className="relative my-6 sm:my-8">
                ...
                <div className="relative flex justify-center text-xs sm:text-sm">
                  <span className="px-3 sm:px-4 bg-white text-gray-500 font-medium">New to bvodo?</span>
                </div>
              </div>
              ...
              {/* Footer */}
              <p className="text-center text-[10px] sm:text-xs text-gray-500 mt-6 sm:mt-8">
