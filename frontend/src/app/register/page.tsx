...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4 lg:p-8">
      <div className="w-full max-w-6xl bg-white rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl overflow-hidden border border-gray-100 animate-scale-in">
        <div className="grid lg:grid-cols-2 min-h-[700px] sm:min-h-[800px]">
          {/* Left Side - Visual/Branding - Hidden on mobile */}
          <div className="hidden lg:flex relative bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 p-12 flex-col justify-between overflow-hidden">
          ...
          <div className="p-5 sm:p-8 lg:p-12 flex flex-col justify-center relative">
            {/* Decorative element */}
            <div className="absolute top-0 right-0 w-32 h-32 sm:w-40 sm:h-40 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full blur-2xl sm:blur-3xl opacity-30 -z-10"></div>
            ...
            <div className="max-w-md mx-auto w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                {/* Organization Name */}
                <div className="group">
                  <label htmlFor="organizationName" className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1.5 sm:mb-2">
                    Organization Name
                  </label>
                  <div className="relative">
                    <div className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2">
                      <Building2 className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-focus-within:text-blue-600 transition-colors" />
                    </div>
                    <input
                      id="organizationName"
                      ...
                      required
                      className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-2.5 sm:py-3 text-sm sm:text-base border-2 border-gray-200 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all hover:border-gray-300"
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <div className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2">
                      <User className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-focus-within:text-blue-600 transition-colors" />
                    </div>
                    <input
                      id="fullName"
                      name="fullName"
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <div className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2">
                      <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-focus-within:text-blue-600 transition-colors" />
                    </div>
                    <input
                      id="email"
                      name="email"
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <div className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2">
                      <Lock className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-focus-within:text-blue-600 transition-colors" />
                    </div>
                    <input
                      id="password"
                      name="password"
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <div className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2">
                      <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-focus-within:text-blue-600 transition-colors" />
                    </div>
                    <input
                      id="confirmPassword"
                ...
                <div className="flex items-start">
                  <input
                    ...
                    type="checkbox"
                    required
                    className="w-3.5 h-3.5 sm:w-4 sm:h-4 mt-1 text-blue-600 border-gray-300 rounded focus:ring-blue-500 cursor-pointer"
                  />
                  <label htmlFor="terms" className="ml-2 text-xs sm:text-sm text-gray-700 cursor-pointer">
                    I agree to the{' '}
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="group w-full px-5 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-base bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg sm:rounded-xl hover:shadow-xl sm:hover:shadow-2xl transition-all duration-300 font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:scale-[1.02]"
                >
              ...
              <Link
                href="/login"
                className="block w-full px-5 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-base bg-gradient-to-r from-gray-100 to-gray-50 text-gray-700 rounded-lg sm:rounded-xl hover:from-gray-200 hover:to-gray-100 transition-all duration-300 font-semibold text-center border-2 border-gray-200 hover:border-gray-300 hover:scale-[1.02]"
              >
                Sign In Instead
              </Link>

              {/* Trust badges */}
              <div className="mt-5 sm:mt-6 flex items-center justify-center gap-4 sm:gap-6 text-[10px] sm:text-xs text-gray-500">
