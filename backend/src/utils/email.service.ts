            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
              ...
              <tr>
                <td style="padding: 40px 30px;">
                  ...
                  <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                    <strong>${inviterName}</strong> has invited you to join <strong>${organizationName}</strong> on <strong>bvodo</strong>, the corporate travel platform.
                  </p>
                      ...
                      <td style="padding: 24px;">
                        ...
                        <table width="100%" cellpadding="8" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td align="right" style="color: #10b981; font-size: 16px; font-weight: 600;">
                  ...
                  <div style="background: linear-gradient(135deg, #dbeafe 0%, #e0e7ff 100%); border-radius: 12px; padding: 24px; margin: 30px 0;">
                    ...
                    <ol style="margin: 0; padding-left: 20px; color: #1e3a8a;">
                      <li style="margin-bottom: 12px; line-height: 1.6;">Click the "Accept Invitation" button below</li>
                      <li style="margin-bottom: 12px; line-height: 1.6;">Create a secure password for your account</li>
                      <li style="margin-bottom: 0; line-height: 1.6;">Start managing your corporate travel bookings</li>
                    </ol>
                  </div>
